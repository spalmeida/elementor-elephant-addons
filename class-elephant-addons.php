...
final class Elephant_addons {
	...
	public function i18n() {
		load_plugin_textdomain( 'elephant-addons' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEPHANT_ADDONS ) );
